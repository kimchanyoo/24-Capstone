...
@Getter
public class ExpireBoardResponseDto extends ResponseDto {

	private ExpireBoardResponseDto(){
		super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
	}

	public static ResponseEntity<ExpireBoardResponseDto> success(){
		ExpireBoardResponseDto responseBody = new ExpireBoardResponseDto();
