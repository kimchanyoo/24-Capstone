...
import { FindIdRequestDto } from "apis/request/auth";
import { FindIdResponseDto } from "apis/response/auth";
import { findIdRequest } from "apis";
...
export const FindIDPage = () => {
    ...
    const FindIdButtonClickHandler = () => {
    ...
    const onCheckCertificationButtonClickHandler = () => {
        ...
        if (!name.trim()){
            alert('이름을 입력해주세요.'); // 필드가 비어있다면 사용자에게 알림
            return;
        }
            ...
            <Container>
                <Content>
                    ...
                    <Group>
                        ...
                        <InterGroup>
                            <Group>
                                <Button label="아이디 찾기" color="#7C7FD1" onClick={FindIdButtonClickHandler}/>
                            </Group>
                        </InterGroup>
                        <InterGroup>
